...
export const description: INodeProperties[] = [
	{
		...
		description: `Unsubscribing from executions stops real-time execution event delivery.`,
	},
];
...
export async function execute(
	...
	const response = await lmaxApiRequest<Record<string, unknown>>(
		this,
		'POST',
		'/secure/execution/unsubscribe',
		{
			executionUnsubscriptionRequest: {},
		},
	);
	...
	return [
		{
			json: {
				success: true,
				subscribed: false,
				message: 'Successfully unsubscribed from execution updates',
