...
export const description: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				resource: ['marketData'],
				operation: ['getTopOfBook'],
			},
		},
		description: 'Instrument ID to get top of book for',
	},
];
...
export async function execute(
	...
	const topOfBook = extractResponseData<Record<string, unknown>>(
		response.data || {},
		'topOfBook',
		'orderBookData',
	);
